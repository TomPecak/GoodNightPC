...
allowed_extensions = ['.toml', '.rs', '.html', '.css', '.js', '.json']

# Lista zablokowanych katalogów
blocked_dirs = ['.vscode', 'node_modules', '.git', 'migrations', 'gen', 'target', 'dist', 'build']

# Lista zablokowanych plików (pełne nazwy plików)
blocked_files = ['dump_output.txt', 'dump_project.py', '.gitignore', 'alembic.ini', '__init__.py', 'package-lock.json']
